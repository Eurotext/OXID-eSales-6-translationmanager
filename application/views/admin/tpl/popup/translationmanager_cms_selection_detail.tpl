...
<table width="100%">
    ...
    <tr class="edittext">
        <td align="center"><b>[{ oxmultilang ident="EXPORT_MAIN_ALLCMS" }]</b></td>
        <td align="center"><b>[{ oxmultilang ident="EXPORT_MAIN_CMSINPROJECT" }]</b></td>
    </tr>
    <tr>
...
<script type="text/javascript">
    $E.onDOMReady( function() {
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc(
            ...
            '[{ $oViewConf->getAjaxLink() }]cmpid=container1&container=translationmanager_cms_selection&projectid=[{ $oxid }]'
        );

        YAHOO.oxid.container2 = new YAHOO.oxid.aoc(
            'container2',
            [{$traslHeaders.container2|@json_encode}],
            '[{ $oViewConf->getAjaxLink() }]cmpid=container2&container=translationmanager_cms_selection&projectid=[{ $oxid }]'
        );
