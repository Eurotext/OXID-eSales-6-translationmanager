 ...
 *
 */
class ProjectToCategory extends \OxidEsales\Eshop\Core\Model\BaseModel
{

    /**
     * @var string Name of current class
     */
    protected $_sClassName = '\Eurotext\Translationmanager\Model\ProjectToCategory';
    ...
    {
        parent::__construct();
        $this->init('ettm_project2category');
    }
     ...
     *
     * @return int Amount of items of type Category
     */
    public function countItemsForProject($sProjectId)
    {
        $oConfig = \OxidEsales\Eshop\Core\Registry::getConfig();
        $sJoinTable = getViewName('ettm_project2category', \OxidEsales\Eshop\Core\Registry::getConfig()->getRequestParameter('editlanguage'));
