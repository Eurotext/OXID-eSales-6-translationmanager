 ...
 *
 */
class CategoriesSelectionMain extends \OxidEsales\Eshop\Application\Controller\Admin\AdminDetailsController
{
    /**
     ...
     * @var string
     */
    protected $_sThisTemplate = 'translationmanager6_categories_selection_detail.tpl';
    ...
    {
        $oAjaxHandler = oxNew('\Eurotext\Translationmanager\Controller\Admin\Popup\CategoriesSelectionAjax');
